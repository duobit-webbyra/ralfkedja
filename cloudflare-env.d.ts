/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 80e7a623f48f2a1a31c01513e2eee932)
// Runtime types generated with workerd@1.20251001.0 2025-08-15 global_fetch_strictly_public,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_SECRET" | "EMAIL_USER" | "EMAIL_PASS" | "CLOUDFLARE_TURNSTILE_SECRET_KEY" | "NEXT_PUBLIC_CLOUDFLARE_TURNSTILE_SITE_KEY" | "RESEND_API_KEY" | "NEXT_PUBLIC_APP_URL">> {}
}
